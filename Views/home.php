...
<div class="wrapper">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="assets/images/avatar.pgn" alt="User Avatar" class="img-size-50 mr-3 img-circle">
  ...
  <aside class="main-sidebar sidebar-white-primary elevation-4">
    ...
    <a href="" class="brand-link bg-primary">
      <img src="assets/images/logo-RV.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">Tienda Virtual</span>
    </a>

    <!-- Sidebar -->
    <div class="sidebar sidebar-white-primary">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex ">
        ...
        <div class="info">
          <a href="#" class="d-block">Rony Ventura</a>
        </div>
      </div>
